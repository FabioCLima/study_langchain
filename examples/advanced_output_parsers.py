...
class EventInfo(BaseModel):
    ...
    duration_hours: Optional[float] = Field(default=None, description="Duração em horas")
...
class AppointmentAnalysis(BaseModel):
    ...
    duration_minutes: Optional[int] = Field(default=None, description="Duração em minutos")
...
class TaskInfo(BaseModel):
    ...
    estimated_hours: Optional[float] = Field(default=None, description="Horas estimadas", ge=0.0)
...
class AdvancedOutputParser:
    ...
    def parse_event_safe(self, text: str) -> Optional[EventInfo]:
    ...
    def parse_sentiment_safe(self, text: str) -> Optional[SentimentAnalysis]:
    ...
    def parse_appointment_safe(self, text: str) -> Optional[AppointmentAnalysis]:
    ...
    def parse_task_safe(self, text: str) -> Optional[TaskInfo]:
