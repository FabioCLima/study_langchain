...
def categorize_file(file_path: Path) -> str:
    ...
    if "chatbot" in content_keywords:
        return "projects/chatbot/src"
    if "travel" in content_keywords:
        return "projects/travel_agent/src"
    if "sentiment" in content_keywords:
        return "projects/sentiment_analyzer/src"
    if "rag" in content_keywords:
...
def execute_organization(
    organization_plan: dict[str, list[Path]], dry_run: bool = True
):
