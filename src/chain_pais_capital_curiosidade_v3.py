...
def setup_langsmith(settings: AppSettings) -> Optional[Client]:
    """
...
# ============================================================
def create_main_pipeline(settings: AppSettings, langsmith_client: Optional[Client] = None):
    """
...
def consultar_pais(
    ...
    try:
        ...
        error_msg = f"❌ Erro ao consultar '{nome_pais}': {str(e)}"
        print(error_msg)
        return error_msg
...
# ============================================================
def analisar_execucoes(settings: AppSettings, project_name: Optional[str] = None):
    """
